...
- [Obsidian](/blogs/wiki/tools/obsidian/) — ローカルファースト PKM ツールとの連携

## ソース記事

- [MemPalace とは？LongMemEval 96.6%を記録した AI メモリシステムの仕組みと論争](/blogs/posts/2026/04/2026-04-13-mempalace-ai-memory/) — 2026-04-13
