...
Anthropic の事例では、Planner・Generator・Evaluator の3エージェント構成で、Claude が6時間かけてフルスタックアプリケーションを自律構築している。詳細は「[Anthropic の3エージェント・ハーネス設計](/blogs/posts/2026/03/2026-03-27-anthropic-harness-design-three-agents/)」を参照。
